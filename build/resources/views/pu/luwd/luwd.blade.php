        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Layanan Urusan Wajib Dasar</h5>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $(document).on('click', '#add', function() {
                $('#modal').modal('show');
                $('#form').attr('action', '{{ url('kud/create/2/9') }}');
        });
        ...
        $(document).on('click', '#edit', function() {
                ...
                $('#form').attr('action', '{{ url('kud/update/2') }}/'+data.id);
        });
