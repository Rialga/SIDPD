        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Pemberdayaan Perempuan dan Perlindungan Anak</h5>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $(document).on('click', '#add', function() {
                $('#modal').modal('show');
                $('#form').attr('action', '{{ url('kud/create/3/16') }}');
        });
