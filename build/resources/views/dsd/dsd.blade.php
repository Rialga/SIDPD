        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Daya Saing Daerah</h5>
...
<script>
    ...
    $(document).ready( function () {
        ...
        $(document).on('click', '#add', function() {
                $('#modal').modal('show');
                $('#form').attr('action', '{{ url('dsd/create') }}');
        });
        ...
        $(document).on('click', '#edit', function() {
                ...
                $('#form').attr('action', '{{ url('dsd/update') }}/'+data.id);
        });
